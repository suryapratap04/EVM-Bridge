...
//             className="bg-yellow-500 text-black py-4 px-8 rounded-full font-semibold w-full text-lg hover:bg-yellow-400 transition disabled:opacity-50 disabled:cursor-not-allowed"
//           >
